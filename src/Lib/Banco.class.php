...
final class Banco 
{
	 ...
	 */
  	...
  	/**
  	 * Singleton Database to get instance
  	 * 
  	 * @return Banco 
  	 */
	...
	{    	
		...
		// Setting encoding 							  
		$this->obj_PDO->exec("SET NAMES $encod");

    	$this->escrever('Connecting to Database \'' . Config::get('pdo.driver') . '\'');
  	}
